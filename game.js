...
function buildFixedDeck(deckType) {
    ...
    // デッキタイプごとに条件分岐する
    if (deckType === '287期受験生') {
        ids = ["A043","A043","A044","A039","A040","A040","0002","0002","0010","0010","0004","0004","0156","0156","0003","0003","0012","0012","0031","0031","0017","0017","0023","0023","0032","0032","0036","0036","0016","0016"];
    ...
    } else if (deckType === 'デッキ名C') { // 3つ目のデッキ名を入れてください
    ...
    } else if (deckType === 'デッキ名D') { // 4つ目のデッキ名を入れてください
